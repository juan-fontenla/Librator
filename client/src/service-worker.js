...
workbox.core.setCacheNameDetails({ prefix: "LibratorPWA" });
...
workbox.routing.registerRoute(
  ...
  workbox.strategies.networkFirst({
    ...
    plugins: [
      ...
      new workbox.backgroundSync.Plugin("offline-petition-queue-post", {
...
workbox.routing.registerRoute(
  ...
  workbox.strategies.networkFirst({
    ...
    plugins: [
      ...
      new workbox.backgroundSync.Plugin("offline-petition-queue-put", {
        maxRetentionTime: 3600,
      }),
      new workbox.cacheableResponse.Plugin({
        statuses: [0, 200],
...
workbox.routing.registerRoute(
  ...
  workbox.strategies.networkFirst({
    ...
    plugins: [
      ...
      new workbox.backgroundSync.Plugin("offline-petition-queue-delete", {
        maxRetentionTime: 3600,
      }),
      new workbox.cacheableResponse.Plugin({
        statuses: [0, 200],
